#include "sdkconfig.h" //Configuración del SDK
...
// Solamente cambiamos el numero de pin de 2 (el del ESP) al pin 23 que conectamos hacia el LED externo
